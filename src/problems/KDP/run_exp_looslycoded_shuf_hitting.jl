...
path_results_time = "./results/results_exphit_kdp_loose_shuf_$(exp_idx_offset)_time.csv"
path_results_evals = "./results/results_exphit_kdp_loose_shuf_$(exp_idx_offset)_evals.csv"
path_results_time_hit = "./results/results_exphit_kdp_loose_shuf_$(exp_idx_offset)_time_hit.csv"
path_results_evals_hit = "./results/results_exphit_kdp_loose_shuf_$(exp_idx_offset)_evals_hit.csv"
