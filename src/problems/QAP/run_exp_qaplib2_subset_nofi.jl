...
path_results_time = "./results/results_qap_qaplib_qgomnofi_$(exp_idx_offset)_time.csv"
path_results_evals = "./results/results_qap_qaplib_qgomnofi_$(exp_idx_offset)_evals.csv"
