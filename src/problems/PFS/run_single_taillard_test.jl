...
path_results_time = "./results/results_pfs_total_taillard_instance$(instance_idx)_approach$(approach_idx)_exp$(exp_idx)_time.csv"
path_results_evals = "./results/results_pfs_total_taillard_instance$(instance_idx)_approach$(approach_idx)_exp$(exp_idx)_evals.csv"
...
approaches = [
    ...
    ("Original Permutation GOMEA - LT",
        (f, n, t, e) -> optimize_permutationgomea(f, n, t, e, fos_type=:original)),
    ("Original Permutation GOMEA - RT",
        (f, n, t, e) -> optimize_permutationgomea(f, n, t, e, fos_type=:random)),
]
...
# Sort instances for consistency between OSes.
sort!(instances)
...
begin
    ...
    bb_warmup = bb_wrap_pfs_tft(instance_warmup)
