...
path_results_time = "./results/results_oas_sat_$(exp_idx_offset)_time.csv"
path_results_evals = "./results/results_oas_sat_$(exp_idx_offset)_evals.csv"
path_instances = "./instances/Dataset_Satellite"
