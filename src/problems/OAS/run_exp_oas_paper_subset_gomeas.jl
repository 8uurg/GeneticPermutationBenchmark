...
path_results_time = "./results/results_oas_px_rrg_$(exp_idx_offset)_time.csv"
path_results_evals = "./results/results_oas_px_rrg_$(exp_idx_offset)_evals.csv"
...
# Find instance files.
instances = glob(string(path_instances, "/100orders/*/*/*_1.txt"))
