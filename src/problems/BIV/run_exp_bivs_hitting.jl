...
path_results_time = "./results/results_exphit_biv_$(exp_idx_offset)_time.csv"
path_results_evals = "./results/results_exphit_biv_$(exp_idx_offset)_evals.csv"
path_results_time_hit = "./results/results_exphit_biv_$(exp_idx_offset)_time_hit.csv"
path_results_evals_hit = "./results/results_exphit_biv_$(exp_idx_offset)_evals_hit.csv"
...
begin
    ...
    Threads.@threads for ((instance_name, instance, instance_opt), (approach_name, optimize_approach), exp_i) in experiments
        ...
        push!(results_time_hit_thread[Threads.threadid()], (instance_name, approach_name, exp_i + exp_idx_offset, trace.hitting_time[], fitness))
        push!(results_eval_hit_thread[Threads.threadid()], (instance_name, approach_name, exp_i + exp_idx_offset, evals.hitting_eval[], fitness))
        next!(progress)
        # unlock(results_lock)
    end
